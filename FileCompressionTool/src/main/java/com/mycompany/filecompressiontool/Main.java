package com.mycompany.filecompressiontool;
...
public class Main extends JFrame implements ActionListener {
	...
	public JPanel createContentPane() {
		...
		blueLabel = new JLabel("After ZIP/UNZIP file size: ");
	...
	private static void createAndShowGUI() {
					...
					public void actionPerformed(ActionEvent event) {
						JOptionPane.showMessageDialog(null,
								"Two algorithms are used for file compression" + "\n" + "1. Huffman Encoding" + "\n"
										+ "2. Lampel-Ziv-Welch Encoding" + "\n" + "\n"
                                                                        
										+ "To compress a file first open the file then click-" + "\n" + "\n"
                                                                        
										+ "ZIP Huffman to zip the file using Huffman algorithm. A zipped" + "\n"
										+ "file with extension .huffz will be created in the same" + "\n"
										+ "folder. This is the zipped & compressed file. During unzipping, just open" + "\n"
										+ "this file and click UNZIP Huffman button." + "\n"

										+ "Same will happen for Lempel-Ziv-Welch algorithm. Zipped file's extension will be .LmZWp" + "\n"
										+ "for Lempel-Ziv-Algorithm. " +"\n" +"\n"
                                                                                + "Always make sure that during unzipping you must use" + "\n"
		...
		aboutItem.addActionListener(
				...
				new ActionListener() {
					public void actionPerformed(ActionEvent event) {
						JOptionPane.showMessageDialog(null,
								"File Compression tool is a Java software to ZIP & UNZIP (.txt) files in order to reduce file size." + "\n"  +"\n"
										+ "It is developed on JAVA RE, as a project of CSE 206 - Algorithms Lab Course" + "\n"
										+ "Deptartment of CSE, Green University of Bangladesh." + "\n"
										+ "It is built by Md. Shahidul Islam Prodhan (St. ID 213902017) " + "\n"
										+ "Spring 2023, Green University of Bangladesh",
